...
_G.Configuration = {
	--// Reporting
	["Enabled"] = true,
	["Webhook"] = "https://discord.com/api/webhooks/1384593169244618864/jBTl_rZMeOA6vnNnR1heXP-moLgLxRJeG1TN3eDpzZ7q2s2NGhFLL32I1zSJfMtyyqvt", -- replace with your webhook url
		...
		embeds = {
			{
				...
				fields = Fields,
				footer = {
					text = "osuka // stock bot" -- Please keep
				},
				timestamp = TimeStamp
			}
		}
